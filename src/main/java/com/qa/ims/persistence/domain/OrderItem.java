...
public class OrderItem {
	...
	public OrderItem(Long order_items_id, Long order_id, Long item_id, Long quantity) {
	...
	public String toString() {
		return "OrderItem [order_items_id=" + order_items_id + ", order_id=" + order_id + ", item_id=" + item_id
				+ ", quantity=" + quantity + "]";
	}
